...
class Calculator(QWidget):
    def __init__(self):
        ...
        # горизонтальные оси выравнивания
        ...
        self.b_erase = QPushButton("e", self)
        ...
        self.b_minus.clicked.connect(lambda: self._oreration("-"))
        ...
        self.b_erase.clicked.connect(lambda: self._erase.text)
